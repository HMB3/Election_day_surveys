...
#### **Fig A). Survey responses, aggregated by all topics (left), and by role for logistics questions (right. Note ROs were excluded from the index analysis)**

```{r fig.align = "center", fig.width = 15, fig.height = 7}

## Arrange a grid
plot_grid(bp_resposes_all, 
          respondent_role_boxplots[["Logistics_boxplot"]],
          nrow = 1,
...
## Arrange a grid
plot_grid(respondent_demo_boxplots[["Logistics_boxplot"]], 
          respondent_remoteness_boxplots[["Logistics_boxplot"]],
          nrow = 1,
          label_size = 5, 
          align = 'hv')
...
The map below shows the index of survey responses for logistics questions in the LG21 staff survey. The underlying data are the same index
