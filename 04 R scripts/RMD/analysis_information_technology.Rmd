...
The following analysis is based on information technology questions in the LG21 staff survey, using only complete responses 
...
#### **Fig A). Survey responses, aggregated by all topics (left), and by role for information technology questions (right. Note ROs were excluded from the index analysis)**

```{r fig.align = "center", fig.width = 15, fig.height = 7}

## Arrange a grid
plot_grid(bp_resposes_all, 
          respondent_role_boxplots[["IS_boxplot"]],
          nrow = 1,
...
## Arrange a grid
plot_grid(respondent_demo_boxplots[["IS_boxplot"]], 
          respondent_remoteness_boxplots[["IS_boxplot"]],
          nrow = 1,
          label_size = 5, align = 'hv')
```
...
#### **Fig C). Information technology survey responses by RO Region**
...
RO_region_polygon_index_maps[["IS_polygon_map"]]
